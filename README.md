# Making look nice work good: design tips for devs.
### @merxplat & @sereeena

As a dev you have the power to make heinous, unusable software that technically works. You also have the power to make it very difficult for everyone trying to make your software less heinous and unusable. 

Basic design, info architecture, typography principles
  Gestalt shiz - http://www.andyrutledge.com/gestalt-principles-1-figure-ground-relationship.php 
  Information hierarchy
  Typography - http://practicaltypography.com/
Working with designers? 
  Just thinking of devs who have a lot of feelpinions about design but are terrible at it
  yeah i think that’d be handy!
The importance of usability, not just functionality
  If no one can use your Cool Thing, you’ve just wasted all that time building it :(
  Guerilla user testing
Designing systems for good interfaces?
  Something about modular CSS architecture for consistent interfaces
